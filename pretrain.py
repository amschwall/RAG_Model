...
def main():
    ...
    # Build dataset for span corruption
    code_snippets = [row["whole_func_string"] for row in methods]
    train_dataset = SpanCorruptionDataset(code_snippets, tokenizer)
    ...
    print("Starting 3‑epoch pretraining...")
    ...
    model.save_pretrained("pretrained_t5")
    tokenizer.save_pretrained("pretrained_t5")
    print("Model saved to pretrained_t5/")
